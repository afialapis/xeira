...
const cxeira= blue
const ctitle= cyan_light
const ccmd= magenta_bold
const coption_name= magenta
const coption_value= white_bold
const cexample= gray_light
const cfilename= gray_italic

const cok = green
const cwarn = yellow_light
const cerror =red_bold
